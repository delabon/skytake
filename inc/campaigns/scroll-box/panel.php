...
$panel->add_setting( 'template', [
    ...
    'output' => HTML::radio_images(array( 
        ...
        'items' => array(
            'classic' => array(
                'url' => SKYTAKE_URL . '/assets/img/templates/scroll-box/classic.png',
            ...
            // 'fashion' => array(
            //     'url' => SKYTAKE_URL . '/assets/img/templates/scroll-box/fashion.png',
...
$panel->add_setting( 'scroll_box_position', [
    'section' => 'style',
    'output' => HTML::select(array( 
        'title' => __('Position', 'skytake'),
        'name' => 'scroll_box_position',
        'value' => $campaign->setting('scroll_box_position'),
        'items' => [
