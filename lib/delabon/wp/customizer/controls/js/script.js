...
jQuery( document ).ready( function( $ ) {
	...
	$( '.dlb-alpha-color-control' ).each( function() {
	...
	// Radio Icons
	$('.dlb-radio-icons-container [type="radio"]').on('change', function(e){
		var _self = $(this);

		_self.closest('.dlb-radio-icons-container').find('.__active').removeClass('__active');
